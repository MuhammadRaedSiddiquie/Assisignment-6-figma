...
function Testimonials() {
  return (
    <div className='bg-[#f7f7f7] w-full h-[130vh] flex flex-col items-center justify-center gap-[50px]'>
      ...
      <div className='w-[90%] h-[50%] flex flex-col items-center justify-between'>
