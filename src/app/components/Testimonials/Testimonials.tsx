...
function Testimonials() {
  return (
    <div className='bg-[#f7f7f7] w-full h-[130vh] flex flex-col items-center justify-center gap-[50px] max-md:h-fit max-md:py-[36px]'>
      <div className='w-[95%] h-[18%] flex flex-col items-start justify-between max-md:h-[14%] max-md:items-center'>
        <h2 className='roboto-bold text-[48px] text-start max-md:text-center max-md:text-[30px] max-md:leading-[2.5rem]'>Customer Testimonials</h2>
        <p className='roboto-regular text-[18px] text-start max-md:text-center'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
      </div>
