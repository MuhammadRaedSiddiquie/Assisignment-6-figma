  ...
  return (
    <section className='w-full h-fit bg-[#ffffff] flex flex-col justify-center items-center py-[110px] gap-[60px] max-md:py-[64px] max-md:gap-[48px] max-md:py-[48px]'>
      <div className='flex flex-col w-[66%] h-[20%] items-center justify-between max-md:text-center max-md:w-[80%] max-md:gap-[10px]'>
        <h1 className='roboto-bold text-[56px] text-black max-md:text-[32px]'>Courses</h1>
        <p className='text-[18px] robot-regular text-black'>Your Ultimate Guide to learning</p>
      </div>
      <div className='w-[95%] h-[1140px] flex flex-col items-center justify-between gap-[60px] max-md:h-fit'>
        <ul className='w-[40%] h-[40px] flex items-center justify-between max-md:w-[100%]'>
          <li className='h-full border-solid border-black text-black border-b-2 roboto-regular text-[16px] px-[16px] py-[8px]'>Popular</li>
          <li className='h-full border-solid border-black text-black roboto-regular text-[16px] px-[16px] py-[8px]'>Recommended</li>
          <li className='h-full border-solid border-black text-black roboto-regular text-[16px] px-[16px] py-[8px]'>Best Price</li>
        </ul>
