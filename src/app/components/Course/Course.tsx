...
function Course() {
  return (
    <section className='w-full h-fit bg-[#ffffff] flex flex-col justify-center items-center py-[110px] gap-[60px]'>
      <div className='flex flex-col w-[66%] h-[20%] items-center justify-between'>
        <h1 className='roboto-bold text-[56px]'>Courses</h1>
        <p className='text-[18px] robot-regular'>Your Ultimate Guide to learning</p>
      </div>
      <div className='w-[95%] h-[1140px] flex flex-col items-center justify-between gap=[60px]'>
        <ul className='w-[40%] h-[40px] flex items-center justify-between'>
